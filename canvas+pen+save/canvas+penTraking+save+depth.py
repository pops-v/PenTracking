...
cv2.createTrackbar("Lower-H", "Trackbars", 61, 179, nothing)
cv2.createTrackbar("Lower-S", "Trackbars", 47, 255, nothing)
cv2.createTrackbar("Lower-V", "Trackbars", 104, 255, nothing)
...
# Add this function to calculate depth
