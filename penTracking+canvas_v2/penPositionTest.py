        ...
        if contours:
            ...
            if cv2.contourArea(largest_contour) > 500:  # Filter small objects
                ...
                if M["m00"] > 0:
                    ...
                    # Draw on the canvas if the pen is detected and within a certain depth range
                    if prev_x is not None and prev_y is not None and 10 < depth < 200 and 135 <= angle <= 180:   # Adjust depth range as needed
